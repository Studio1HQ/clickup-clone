  ...
  return (
    <div className="w-64 bg-white border-r border-border flex flex-col h-screen">
      ...
      <div className="p-4 border-b border-border">
        <button className="flex items-center justify-between w-full hover:bg-muted/50 p-2 rounded-lg transition-colors">
      ...
      {/* Views */}
      <div className="p-3">
        <div className="text-xs font-semibold text-muted-foreground mb-2 px-2">VIEWS</div>
      ...
      <div className="p-3 flex-1 overflow-y-auto">
        <div className="flex items-center justify-between mb-2 px-2">
          ...
          <button className="hover:bg-muted/50 p-1 rounded transition-colors">
      ...
      <div className="p-4 border-t border-border">
        <div className="flex items-center gap-3">
          ...
          <div className="flex gap-1">
            <button className="hover:bg-muted/50 p-1.5 rounded transition-colors">
